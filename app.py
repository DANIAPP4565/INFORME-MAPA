...
def _ocr_pdf_pages(pdf_file, dpi=260, lang="spa+eng"):
    ...
    if err:
        raise RuntimeError(
            ...
            "Falta una dependencia de OCR. Instalación Python: pip install PyMuPDF pillow pytesseract. "
            "En Streamlit Cloud agregá PyMuPDF, Pillow y pytesseract a requirements.txt. "
            "Además instalá Tesseract OCR en el sistema o agregá tesseract-ocr y tesseract-ocr-spa a packages.txt. "
            "Detalle técnico: " + err
        )
